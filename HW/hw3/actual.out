...
valid Command Line Processor command.  During SQL processing it returned:
SQL0407N  Assignment of a NULL value to a NOT NULL column "TBSPACEID=2,
TABLEID=4, COLNO=1" is not allowed.  SQLSTATE=23502
...
satisfy the check constraint "HW3.STUDENT.SQL210412000941770".  SQLSTATE=23513
...
valid Command Line Processor command.  During SQL processing it returned:
SQL0407N  Assignment of a NULL value to a NOT NULL column "TBSPACEID=2,
TABLEID=5, COLNO=1" is not allowed.  SQLSTATE=23502

INSERT INTO hw3.class VALUES ('00012','CS25',NULL)
DB21034E  The command was processed as an SQL statement because it was not a
valid Command Line Processor command.  During SQL processing it returned:
SQL0407N  Assignment of a NULL value to a NOT NULL column "TBSPACEID=2,
TABLEID=5, COLNO=2" is not allowed.  SQLSTATE=23502

INSERT INTO hw3.class_prereq VALUES ('00010','99999')
DB21034E  The command was processed as an SQL statement because it was not a 
valid Command Line Processor command.  During SQL processing it returned:
SQL0530N  The insert or update value of the FOREIGN KEY
"HW3.CLASS_PREREQ.SQL210412000943890" is not equal to any value of the parent
...
valid Command Line Processor command.  During SQL processing it returned:
SQL0407N  Assignment of a NULL value to a NOT NULL column "TBSPACEID=2,
TABLEID=6, COLNO=1" is not allowed.  SQLSTATE=23502

INSERT INTO hw3.class_prereq VALUES ('99999','00010')
DB21034E  The command was processed as an SQL statement because it was not a 
valid Command Line Processor command.  During SQL processing it returned:
SQL0530N  The insert or update value of the FOREIGN KEY
"HW3.CLASS_PREREQ.SQL210412000943850" is not equal to any value of the parent
key of the parent table.  SQLSTATE=23503
...
valid Command Line Processor command.  During SQL processing it returned:
SQL0530N  The insert or update value of the FOREIGN KEY
"HW3.SCHEDULE.SQL210412000944750" is not equal to any value of the parent key
...
valid Command Line Processor command.  During SQL processing it returned:
SQL0530N  The insert or update value of the FOREIGN KEY
"HW3.SCHEDULE.SQL210412000944790" is not equal to any value of the parent key
of the parent table.  SQLSTATE=23503
...
valid Command Line Processor command.  During SQL processing it returned:
SQL0545N  The requested operation is not allowed because a row does not
satisfy the check constraint "HW3.SCHEDULE.SQL210412000944570".
SQLSTATE=23513
...
valid Command Line Processor command.  During SQL processing it returned:
SQL0545N  The requested operation is not allowed because a row does not
satisfy the check constraint "HW3.SCHEDULE.SQL210412000944690".
SQLSTATE=23513
